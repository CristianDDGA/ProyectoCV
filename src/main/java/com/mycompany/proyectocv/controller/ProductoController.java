...
public class ProductoController implements ActionListener {
    ...
    public ProductoController(VistaAdmin vista, ProductoDAO dao) {
        ...
        // Escáner Admin: Enter en el campo dispara el procesado
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == vista.jBtnGuardar) {
            ...
            if (vista.jTxtNombre.getText().trim().isEmpty() || vista.jTxtPrecio.getText().trim().isEmpty()) {
            ...
            if (codigoIngresado.isEmpty()) {
                ...
                vista.TxtCodigo.setText(codigoIngresado);
            } else if (!codigoEscaneado && dao.codigoExiste(codigoIngresado)) {
    ...
    // Se activa al presionar Enter en jTxtEscanerAdmin
    // =======================================================
